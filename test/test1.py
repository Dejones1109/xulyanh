...
# cv2.putText(image, 'point1', (point1[0] - 10, point1[1] - 20), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0, 0, 0),
#             lineType=cv2.LINE_AA)
# cv2.circle(image, point2, 8, (200, 100, 55), -1)
# cv2.putText(image, 'point2', (point2[0] - 10, point2[1] - 20), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0, 0, 0),
#             lineType=cv2.LINE_AA)
# cv2.circle(image, point3, 8, (150, 50, 155), -1)
# cv2.putText(image, 'point3', (point3[0] - 10, point3[1] - 20), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0, 0, 0),
#             lineType=cv2.LINE_AA)
